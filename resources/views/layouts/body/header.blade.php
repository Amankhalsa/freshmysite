...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h2 class="logo mr-auto"><a href="{{url('/')}}"><span>Aman</span>Khalsa</a></h2>
      ...
      <nav class="nav-menu d-none d-lg-block">
          ...
          <li class="drop-down"><a href="#">About</a>
            <ul>
              ...
              <li><a href="{{route('Testimonials')}}">Testimonials</a></li>
                                                    <li><a href="http://demo.amankhalsa.in/test/">Temp </a></li>

              <!--<li class="drop-down"><a href="#">Deep Drop Down</a>-->
              <!--  <ul>-->
              <!--    <li><a href="https://github.com/Amankhalsa" target="_blank">My Git</a></li>-->
       ...
       <li class="drop-down"><a href="#">Project</a>
                <ul>
                <li><a href="https://amankhalsa.github.io/Mysite/" target="_blank">Apple Clone</a></li>
                  ...
                  <li><a href="https://github.com/Amankhalsa/50projects50days">50projects</a></li>
                   <li><a href="https://github.com/Amankhalsa/pythonHero">Python</a></li>
                   <li><a href="https://github.com/Amankhalsa/python_notebook">Py Notebook</a></li>
                     <li><a href="{{asset('upload/Sunder-Gutka-Taksal-Damdami-Taksal.pdf')}}"> Sundar Gutka </a></li>
      ...
      <div class="header-social-links">
           <a href="https://github.com/Amankhalsa" class="twitter"><img src="{{asset('frontend/assets/GitHub.png')}}" alt="image of github logo" width="15px" height="15px" target="_blank"></a> 
